...
@SumState.transforms(lang.VarAssignment)
...
@SumState.transforms(lang.ValAssignment)
...
@SumState.transforms(lang.QMarkAssignment)
...
@SumState.transforms(lang.VarIncAssignment)
...
@SumState.transforms(lang.VarDecAssignment)
...
def assume(state, statement):
    ...
    elif isinstance(expr, lang.NotEqualsVar):
        if (
            state.const[expr.lval] == state.const[expr.rval]
            and
            ...
            state.reset()
    elif isinstance(expr, lang.NotEqualsVal):
